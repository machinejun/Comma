...
<br>
## 서비스 구현
![image](https://user-images.githubusercontent.com/99931188/184539538-69160046-fafc-454c-be4e-4860e1e127f5.png)

&nbsp;기존의 우리가 알고 있는 숙박 서비스는 전문적인 숙업업소를 대상으로 하며 숙박업소의 방이라는 물품을 "구매" 하는 방향으로 서비스를 전개되어진다				 때문에 일반적으로 예약시
결제를 우선적으로 진행한다. 하지만 저희의 서비스 대상은 숙박 업체가 아니라 바로 우리 옆에 있는 친구들이기에 기존의 서비스 흐름과 같은 "구매" 와 다르게 친구와의 "약속"과 같이 
아래의 흐름처럼 예약을 진행하기로 하였습니다.
<br>
-- 우리가 생각한 약속의 흐름
1. 내가 시간이 되는가 묻는다.
2. 친구가 가능하다고 대답한다.
