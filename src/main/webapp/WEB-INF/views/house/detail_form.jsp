	...
	<div class="container px-4 px-lg-5 my-5">
		<div class="row gx-4 gx-lg-5 align-items-center">
			...
			<div class="col-md-6">
				...
				<div class="fs-5 mb-5">
					<span class="text-decoration-line-through"><i class="bi bi-geo-alt"></i>&nbsp;${house.address}</span>
				</div>
		...
		<c:forEach var="review" items="${reviews}">
			...
			<c:if test="">
				<div style="cursor: pointer;">
					<p p class="mb-5 float-right" style="cursor: pointer;" data-toggle="modal" data-target="#reply">답글 쓰기</p>
