...
<div class="container">
	...
	<form action="/api/house/add" enctype="multipart/form-data" method="post">
		<div class="form-group">
			...
			<div class="form-group">
				<label><b>지역</b></label> <select class="form-control" id="address" name="address">
					<option>서울</option>
					<option>부산</option>
					<option>대구</option>
					<option>대전</option>
			...
			<div class="form-group">
				<label><b>숙소 유형</b></label> <select class="form-control" id="type" name="type">
					<option>호텔</option>
					<option>모텔</option>
					<option>펜션</option>
			...
			<div class="custom-file">
				<input type="file" name="file" class="custom-file-input" id="imageFile"/> <label class="custom-file-label" for="imageFile">파일을 선택하세요</label>
			</div>
			<div class="form-group">
