...
<div class="container">
	<h2 id="pTranMsg" class="info-txt text-center">
		게시글 작성
		</h1>
		<input type="hidden" id="userId" value="${principal.user.id}"></input> <br />
		<div class="container">
			<div class="container">
				<label for="indvdlNm">제목</label> <input class="form-control" type="text" id="title" name="title" />
			</div>
			<br />
			<div id="dl_tel" class="container">
				<label for="moblPhon">내용</label>
				<!-- 181023_접근성 수정 추가 -->
				<div class="contentArea">
					<textarea type="text" id="content" name="moblPhon" maxlength="11" class="summernote"></textarea>
				</div>
			</div>
		</div>
