		...
		<div class="col-xl">
			<div class="row">
				...
				<div class="col" style="position: absolute; left: 90%;">
					<a href="/guest/review/update_form/${review.id}" style="margin-right: 10px;">수정</a> <a id="btn-delete" onclick="index.deleteReview(${review.id})" style="color: red; margin-right: 10px;">삭제</a>
				</div>
