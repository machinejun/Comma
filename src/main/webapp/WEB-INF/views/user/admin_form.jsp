				...
				<div class="col-xs-12 col-md-12">
					<div id="page-container">
						...
						<div class="d-flex flex-row-reverse">
							...
							<form class="form-inline" action="/user/searchUsername"
								method="get">
								<select name="role"
									style="width: 130px; height: 40px; margin: 10px; margin-top: 12px; border-radius: 5px">
									<option value="">전체</option>
									<option value="guest">GUEST</option>
									<option value="host">HOST</option>
								</select> <input type="text" class="form-control" style="margin: 10px"
									name="q" value="${searchUser}" placeholder="검색어를 입력하세요">
...
<<<<<<< HEAD
														...
														style="font-size: 17px">예약확인</button></td>
											</c:if>
											<c:if test="${user.role eq 'HOST' }">
												<td><button type="submit" class="custom-sm-btn"
														onclick="location.href='/house/management';"
														style="font-size: 17px">숙소정보</button></td>
=======
									                    <td><button type="submit"
														onclick="location.href='/reserveTable/user';"
														class="custom-sm-btn" style="font-size: 17px">예약확인</button></td>
											</c:if>
											<c:if test="${user.role eq 'HOST' }">
												<td><button type="submit"
														onclick="location.href='/house/management';"
														class="custom-sm-btn" style="font-size: 17px">숙소정보</button></td>
<<<<<<< HEAD
