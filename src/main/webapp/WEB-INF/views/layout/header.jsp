...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top">
		<div id="naviBar" class="navbar-expand-lg fixed-top" style="background-color: white; width: 100%;">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item" style="margin-right: 10px;"><a class="nav-link" href="/" style="color: rgba(255,149,149,0.5);">둘러 보기</a></li>
					<li class="nav-item"><a class="nav-link" href="/house/list">과거 행적</a></li>
