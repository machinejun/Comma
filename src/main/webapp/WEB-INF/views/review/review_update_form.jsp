	...
	<form>
		...
		<div class="form-group">
			<div class="form-group">
				...
				<label for="name"><b>${reservation.houseId.name}</b></label> <input
					type="text" class="form-control" id="name" disabled="disabled" />
			</div>
			<div class="form-group">
				<label for="name"><b>${reservation.checkInDate} ~
						${reservation.checkOutDate}</b></label> <input type="text"
			...
			<div class="form-group summernote">
				...
				<textarea class="form-control" rows="10" id="content"
					placeHolder="숙소의 청결도, 위치, 호스트와의 의사소통에 대한 솔직한 후기를 남겨주세요.">${review.content}</textarea>
			</div>
