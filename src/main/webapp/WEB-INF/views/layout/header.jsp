	...
	<div id="user-table" class="list-group">
		...
		<div id="user-box-header">
			...
			<sec:authorize access="hasRole('ROLE_HOST')">
				...
				<a type="button" class="list-group-item list-group-item-action" href="/reserveTable/host"> <span class="icon-users"></span>&nbsp;&nbsp;예약자 확인
				</a>
				<a type="button" class="list-group-item list-group-item-action" href="/house/post_form"> <span class="icon-plus"></span>&nbsp;&nbsp;숙소 등록
				</a>
				<a type="button" class="list-group-item list-group-item-action" href="/house/management"> <span class="icon-plus"></span>&nbsp;&nbsp;숙소 관리
				</a>
			</sec:authorize>
		</div>
	</div>