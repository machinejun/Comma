...
<body>
	...
	<nav class="navbar navbar-expand-lg">
		<div id="naviBar" class="navbar-expand-lg ">
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="/house/list">숙소
						보기</a></li>
	...
	<div id="user-table" class="list-group">
		<a onclick="openUserBox()" id="user-btn-header" class="user-btn"><i
		...
		<div id="user-box-header">
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<a href="/user/my-page"
						class="list-group-item list-group-item-action"> <span
						class="icon-user"></span>&nbsp;&nbsp;${principal.user.role eq 'ADMIN' ? '관리자 페이지' : '마이페이지' }
					</a>
			...
			<sec:authorize access="hasRole('ROLE_GUEST')">
				<a type="button" class="list-group-item list-group-item-action"
					href="/be-host"> <span class="icon-black-tie"></span>&nbsp;&nbsp;호스트
					되기
				</a>
			...
			<sec:authorize access="hasRole('ROLE_HOST')">
				<a type="button" class="list-group-item list-group-item-action"
					href="/be-guest"> <span class="icon-black-tie"></span>&nbsp;&nbsp;게스트
					되기
				</a>
			</sec:authorize>
